...
public class ArchivoBebida {
    ...
    public boolean escribirObjeto(String path) {
        ...
        int cantidadObjetos = ProgramaPrincipal.datos.getBebidas().largo();
        ...
        try {
            ...
            if (cantidadObjetos > 0) {
                for (int i = 0; i < cantidadObjetos; i++) {
                    Bebida obj = (Bebida) ProgramaPrincipal.datos.getBebidas().obtener(i);
                    escribio = true;
    ...
    public void leerObjetos(String nombreArchivo) {
        ...
        try {
            ...
            while (objetoLeido != null) {
                bebida = (Bebida) objetoLeido;
                ProgramaPrincipal.datos.agregarProducto(bebida);
