...
public class ArchivoEmpleado {
    ...
    public boolean escribirObjeto(String path) {
        ...
        int cantidadObjetos = ProgramaPrincipal.datos.getEmpleados().largo();
        ...
        try {
            ...
            if (cantidadObjetos > 0) {
                for (int i = 0; i < cantidadObjetos; i++) {
                    Empleado obj = (Empleado) ProgramaPrincipal.datos.getEmpleados().obtener(i);
                    escribio = true;
    ...
    public void leerObjetos(String nombreArchivo) {
        ...
        try {
            ...
            while (objetoLeido != null) {
                empleado = (Empleado) objetoLeido;
                ProgramaPrincipal.datos.agregarEmpleado(empleado);
