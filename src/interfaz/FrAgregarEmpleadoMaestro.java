 ...
 * @author Nertrox
 */
public class FrAgregarEmpleadoMaestro extends javax.swing.JFrame {
     ...
     * @param opcion
     */
    public FrAgregarEmpleadoMaestro(int opcion) {
        initComponents();
        this.opcion = opcion;
    ...
    private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
        ...
        try {
            ...
            if (validarContra()) {
                ...
                Empleado admin = new Empleado(nombre, apellido, cedula, login, contrasena, numero, true, new Date());
                admin.setUsuarioMaestro(true);
